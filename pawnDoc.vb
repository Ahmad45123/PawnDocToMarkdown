Public Class PawnDoc
    ...
    Public Structure Parameter
        ...
        Public paramExplain As String

        Public Sub New(name As String, explain As String)
            paramName = name
...
#End Region
    ...
    Private p_params As New List(Of Parameter)
        ...
        For Each line As String In lines
            ...
            ElseIf isInAParam Then
                ...
                If currentParam.EndsWith("</param>" + vbCrLf) Then
                    ...
                    'Create the key
                    Parameters.Add(New Parameter(currentParamName, currentParamDesc))
                End If
                Continue For
